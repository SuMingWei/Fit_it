...
public class upperRope_exercise extends AppCompatActivity {
    ...
    private void showPopUpWindow(View v){
        View view = LayoutInflater.from(this).inflate(R.layout.upperrope_popup1, null, false);
    ...
    private void countDownEvent(){
        if(milliLeft >= 200500 && milliLeft <= 210000){
            ...
            if(!intro1) {
                showPopUp_IntroExe1();
                intro1 = true;
                intro_title_iv.setImageResource(R.drawable.pop_uprope1);
                intro_iv1.setImageResource(R.drawable.introduction_uprope1_1);
                intro_iv2.setImageResource(R.drawable.introduction_uprope1_2);
                intro_iv3.setImageResource(R.drawable.introduction_uprope1_3);
                countNumber = 10;
            ...
            if(!intro1) {
                ...
                countNumber = 10;
                intro1 = true;
                intro_title_iv.setImageResource(R.drawable.pop_uprope2);
                intro_iv1.setImageResource(R.drawable.introduction_uprope2_1);
                intro_iv2.setImageResource(R.drawable.introduction_uprope2_2);
                intro_iv3.setImageResource(R.drawable.introduction_uprope2_3);
                intro_next_btn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        IntroExe1.dismiss();
            ...
            if(!intro1) {
                ...
                countNumber = 10;
                showPopUp_IntroExe1();
                intro_title_iv.setImageResource(R.drawable.pop_uprope3);
                intro_iv1.setImageResource(R.drawable.introduction_uprope3_1);
                intro_iv2.setImageResource(R.drawable.introduction_uprope3_2);
                intro_iv3.setImageResource(R.drawable.introduction_uprope3_3);
                intro_next_btn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        IntroExe1.dismiss();
