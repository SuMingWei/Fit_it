...
public class upperRope_exercise extends AppCompatActivity {
    ...
    private void showExe1Popup(){
        View view = LayoutInflater.from(this).inflate(R.layout.upperrope_popup2, null, false);
    ...
    private void showExe2Popup(){
        View view = LayoutInflater.from(this).inflate(R.layout.upperrope_popup3, null, false);
        PopupWindow tmpWindow = new PopupWindow(view,
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, true);
        tmpWindow.showAtLocation(view, Gravity.CENTER_HORIZONTAL,0,0);
        Button next_btn = (Button) view.findViewById(R.id.next_btn);
    ...
    private void showExe3Popup(){
        View view = LayoutInflater.from(this).inflate(R.layout.upperrope_popup4, null, false);
        PopupWindow tmpWindow = new PopupWindow(view,
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, true);
        tmpWindow.showAtLocation(view, Gravity.CENTER_HORIZONTAL,0,0);
        Button next_btn = (Button) view.findViewById(R.id.next_btn);
