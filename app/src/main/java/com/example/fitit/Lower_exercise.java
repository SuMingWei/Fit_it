...
public class Lower_exercise extends AppCompatActivity {
    ...
    //layout use upperlimb, remember to change the pic
    ...
    private void countDownEvent(){
        if(milliLeft >= 200500 && milliLeft <= 210000){
            ...
            if(!intro1) {
                showPopUp_IntroExe1();
                intro_title_iv.setImageResource(R.drawable.pop_lower1);
                intro_iv1.setImageResource(R.drawable.introduction_lower1_1);
                intro_iv2.setImageResource(R.drawable.introduction_lower1_2);
                intro_iv3.setImageResource(R.drawable.introduction_lower1_3);
                intro1 = true;
                countNumber = 10;
            ...
            if(!intro1) {
                ...
                countNumber = 10;
                intro1 = true;
                intro_title_iv.setImageResource(R.drawable.pop_lower2);
                intro_iv1.setImageResource(R.drawable.introduction_lower2_1);
                intro_iv2.setImageResource(R.drawable.introduction_lower2_2);
                intro_iv3.setImageResource(R.drawable.introduction_lower2_3);
                intro_next_btn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        IntroExe1.dismiss();
            ...
            if(!intro1) {
                ...
                countNumber = 10;
                showPopUp_IntroExe1();
                intro_title_iv.setImageResource(R.drawable.pop_lower3);
                intro_iv1.setImageResource(R.drawable.introduction_lower3_1);
                intro_iv2.setImageResource(R.drawable.introduction_lower3_2);
                intro_iv3.setImageResource(R.drawable.introduction_lower3_3);
                intro_next_btn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        IntroExe1.dismiss();
